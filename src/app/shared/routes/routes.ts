export class routes {
  ...
  public static get addquestionnaire(): string
  {
    return this.baseUrl+'/questionnaire/add-questionnaire';
  }
  ...
  public static get addStaffSchedule(): string {
    return this.baseUrl + '/doctor-schedule/staff-schedule';
  }
  public static get addTestSchedule(): string {
    return this.baseUrl + '/doctor-schedule/test-schedule';
  }
